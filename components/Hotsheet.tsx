...
const TopSignalCard = () => (
  <div className="hotsheet-bento__signal-card">
    ...
    <div className="hotsheet-bento__card-meta">
      Confidence: <strong>91</strong>
    </div>
...
const NotificationCard = ({
  ...
  <div className="hotsheet-bento__notif">
    {time && (
      <div className="hotsheet-bento__notif-time">{`// DELIVERED ${time}`}</div>
    )}
...
const StatCard = ({
  ...
  <div
    className={`hotsheet-bento__stat ${accent ? "hotsheet-bento__stat--accent" : ""}`}
  >
...
const DeliveryCard = () => (
  <div className="hotsheet-bento__delivery">
    ...
    <div className="hotsheet-bento__delivery-text">
      ...
      <div className="hotsheet-bento__delivery-sub">
        By 8:00 AM EST, every day
      </div>
    </div>
  </div>
);
    ...
    <section className="hotsheet-hero">
      ...
      >
        ...
        <h2 className="hotsheet-hero__heading">
          The Cheat
          <br />
          Code. <em className="hotsheet-hero__heading-accent">Built</em>
          <br />
          To Hit.
        </h2>
        ...
        <div className="hotsheet-hero__meta">
          <span>$2/day</span>
          <span className="hotsheet-hero__meta-sep" aria-hidden="true">
            ·
          </span>
      ...
      >
        <MagicBento
          className="hotsheet-hero__bento"
          enableSpotlight
          glowColor="228, 242, 34"
        >
          {/* Card 1 — Featured / Top signal (spans 2 rows) */}
          <MagicBentoCard
            className="hotsheet-bento__card hotsheet-bento__card--featured"
            glowColor="228, 242, 34"
          >
            <TopSignalCard />
          </MagicBentoCard>
          ...
          <MagicBentoCard
            className="hotsheet-bento__card"
            glowColor="228, 242, 34"
          >
          ...
          <MagicBentoCard
            className="hotsheet-bento__card hotsheet-bento__card--notif"
            glowColor="228, 242, 34"
          >
            <NotificationCard
          ...
          <MagicBentoCard
            className="hotsheet-bento__card hotsheet-bento__card--delivery"
            glowColor="228, 242, 34"
          >
            <DeliveryCard />
          </MagicBentoCard>
