...
const BasketballCourt = () => (
  ...
  >
    <rect
      ...
      height="166"
      rx="4"
      stroke="rgba(228,242,34,0.25)"
      strokeWidth="1.5"
      fill="rgba(228,242,34,0.02)"
    />
    {/* Center line */}
    <line
      x1="140"
    ...
    {/* Left 3-pt arc */}
    <path
      d="M2,22 Q100,85 2,148"
      stroke="rgba(228,242,34,0.18)"
      strokeWidth="1.2"
      fill="none"
    />
    {/* Right key */}
...
const HockeyRink = () => (
  ...
  >
    ...
    {/* Puck trail */}
    <path
      d="M148,85 Q138,82 130,85 Q122,90 116,84"
      stroke="rgba(228,242,34,0.4)"
      strokeWidth="1"
      strokeDasharray="3 2"
      fill="none"
    />
...
const BaseballDiamond = () => (
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="hss-court hss-court--square"
    aria-hidden="true"
  >
    {/* Outfield arc */}
    <path
      d="M14,196 Q110,14 206,196"
      stroke="rgba(228,242,34,0.18)"
      strokeWidth="1.5"
      fill="rgba(228,242,34,0.02)"
    />
    ...
    {/* Diamond */}
    <polygon
      points="110,46 176,110 110,174 44,110"
      stroke="rgba(228,242,34,0.4)"
      strokeWidth="1.5"
      fill="rgba(228,242,34,0.03)"
    />
    {/* Bases */}
    <rect
      x="103"
    ...
    <circle
      ...
      cy="110"
      r="6"
      stroke="rgba(228,242,34,0.3)"
      strokeWidth="1.2"
      fill="rgba(228,242,34,0.08)"
    />
    {/* Ball trajectory arc */}
    <path
      d="M110,110 Q80,70 43,110"
      stroke="rgba(228,242,34,0.5)"
      strokeWidth="1.5"
      strokeDasharray="4 3"
      fill="none"
...
const FootballField = () => (
  ...
  >
    ...
    <path
      d="M140,128 L140,90 L104,58"
      stroke="rgba(228,242,34,0.65)"
      strokeWidth="1.5"
      strokeDasharray="4 3"
      fill="none"
      strokeLinecap="round"
      ...
      <div className="hss-card__info">
        ...
        <div className="hss-card__score-row">
          <div className="hss-card__score-bar-track">
            <div
              className="hss-card__score-bar-fill"
              style={{ width: `${barPct}%` }}
            />
          </div>
